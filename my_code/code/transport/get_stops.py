...
from my_code.code.transport.connector_with_algos import get_normalized_route
...
def d_with_new_stops(route_objects: RouteCoordinates) -> dict[str, list[Stop]]:
    d = {}
    ...
    for name, url in names_and_ref.items():
        try:
            ...
            for sub_route_time in sub_route_times:
                d_routes[sub_route_time.name] = get_normalized_route(d_stop, sub_route_time)
